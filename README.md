# Unit Testing React Module Project: Stranger Things - Webpt32
...
* [x] cd into the project base directory `cd web-module-project-reducer-pattern` - I think this is the wrong project
